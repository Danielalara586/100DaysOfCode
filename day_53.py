# Day 53: Shooter Game Pt12 (Final Part)
...
# load button images
start_img = pygame.image.load('images/Shooter/start_btn.png').convert_alpha()
exit_img = pygame.image.load('images/Shooter/exit_btn.png').convert_alpha()
restart_img = pygame.image.load('images/Shooter/restart_btn.png').convert_alpha()
# load images
pine1_img = pygame.image.load('images/Shooter/background/pine1.png').convert_alpha()
pine2_img = pygame.image.load('images/Shooter/background/pine2.png').convert_alpha()
mountain_img = pygame.image.load('images/Shooter/background/mountain.png').convert_alpha()
sky_img = pygame.image.load('images/Shooter/background/sky_cloud.png').convert_alpha()
# store tiles in a list
img_list = []
for x in range(TILE_TYPES):
    img = pygame.image.load(f'images/Shooter/tile/{x}.png')
...
class Soldier(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
        ...
        for animation in animation_types:
            ...
            num_of_frames = len(os.listdir(f'images/Shooter/{self.char_type}/{animation}'))
...
with open(f"./level_loader/level{level}_data.csv", newline="") as csv_file:
